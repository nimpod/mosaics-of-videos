...
import RgbHistogram as RGB
import Search as S

# Get user-specified image and video files
...
index = pickle.loads(open("index" + os.path.splitext(os.path.basename(args["videoPath"]))[0] + ".cpickle", "rb").read())
searcher = S.Searcher(index)
